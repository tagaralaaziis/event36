...
export default function CreateEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Konversi format datetime-local ke 'YYYY-MM-DD HH:mm:ss'
      ...
      form.append('startTime', formatDateTime(formData.startTime))
      form.append('endTime', formatDateTime(formData.endTime))
